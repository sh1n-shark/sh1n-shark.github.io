...
export default function LinkTree() {
    ...
    <Container>
      ...
      <Button link='https://discord.gg/vQF4z3C9h7' icon={discordLogo} name='Discord Server' backgroundColor={variables.discordColor} />
      ...
      <Button link='https://www.buymeacoffee.com/sh1nshark' icon={bmcLogo} name='Buy Me A Coffee' backgroundColor={variables.bmcColor}  />
